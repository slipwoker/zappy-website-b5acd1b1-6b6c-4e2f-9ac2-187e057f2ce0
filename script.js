    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Treasure Race uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b5acd1b1-6b6c-4e2f-9ac2-187e057f2ce0',
                    name: data.name || '',
                    email: data.email || '',
